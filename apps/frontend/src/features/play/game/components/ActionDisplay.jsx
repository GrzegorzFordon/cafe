...
function ActionDisplay() {
  ...
  return (
    <motion.div className="absolute top-1/6 left-2 flex size-fit max-w-1/2 flex-col items-start justify-center gap-2 rounded-sm bg-amber-50 p-2 text-sm text-black">
