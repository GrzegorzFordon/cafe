...
function NavBar() {
  ...
  return (
    <nav className="flex fixed top-4 bg-amber-800 rounded-sm w-95/100 justify-between gap-4 px-2 py-4 text-gray-800 font-bold decoration-0 h-12 z-1 shadow-md">
